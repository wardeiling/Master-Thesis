...
data_binx_conty <- glmm_data_generation(N_total = 1000, T_total = 20, predictor.type = "binary", outcome.type = "continuous",
                                        sdX.within = NA, sdX.between = 1, g.00 = 0, g.01 = 1, sd.u0 = 1,
                                        g.10 = 0.5, sd.u1 = 0, sd.e = 1, true_cluster_means = FALSE)
# same values as (1) but without sdX.within
summary(data_binx_conty)
var(data_binx_conty$p.X.mean.j) # is equal to zero when sdX.between is zero, which makes it not a variable.
var(data_binx_conty$X.cluster.means)
...
data_binx_conty <- glmm_data_generation(N_total = 1000, T_total = 20, predictor.type = "binary", outcome.type = "continuous",
                                        sdX.within = NA, sdX.between = 1, g.00 = 0, g.01 = 1, sd.u0 = 1,
                                        g.10 = 0.5, sd.u1 = 0, sd.e = 1, true_cluster_means = TRUE)
# same values as (1) but without sdX.within
summary(data_binx_conty)

...
p1.31 <- ggplot(data_cont, aes(x = b0, y = eta)) + geom_point() + labs(title = "Scatterplot of b0 and eta")
p1.32 <- ggplot(data_cont, aes(x = X.mean.j, y = X.cluster.means)) + geom_point() + labs(title = "Scatterplot of X.mean.j and X.cluster.means")

# combine plots
gridExtra::grid.arrange(p1.31, p1.32, ncol = 2)

# 1.3 overlaying density plots for X.cluster.means and X.mean.j
p1.41 <- ggplot(data_cont, aes(x = X.cluster.means, fill = "X.cluster.means")) + geom_density(alpha = 0.5) +
...
data_cont$diff <- data_cont$X.cluster.means - data_cont$X.mean.j

# plot histogram of differences
p1.42 <- ggplot(data_cont, aes(x = diff)) + geom_histogram(aes(y = ..density..), bins = 30, fill = "lightblue", color = "black") +
...
p2.31 <- ggplot(data_binx_conty, aes(x = p.X.mean.j, y = b0)) + geom_point() + labs(title = "Scatterplot of p.X.mean.j and b0")
p2.32 <- ggplot(data_binx_conty, aes(x = b0, y = eta)) + geom_point() + labs(title = "Scatterplot of b0 and eta")
p2.33 <- ggplot(data_binx_conty, aes(x = X.cluster.means, y = p.X.mean.j)) + geom_point() + labs(title = "Scatterplot of X.cluster.means and p.X.mean.j")

# combine plots
gridExtra::grid.arrange(p2.31, p2.32, p2.33, ncol = 2)

# create overlapping density plots for X.cluster.means and p.X.mean.j
p2.41 <- ggplot(data_binx_conty, aes(x = X.cluster.means, fill = "X.cluster.means")) + geom_histogram(alpha = 0.8, binwidth = 0.02) +
...
# compute difference between estimated and true cluster mean for each cluster
data_binx_conty$diff <- data_binx_conty$X.cluster.means - data_binx_conty$p.X.mean.j

# plot histogram of differences
p2.42 <- ggplot(data_binx_conty, aes(x = diff)) + geom_histogram(aes(y = ..density..), bins = 30, fill = "lightblue", color = "black") +
  geom_density(alpha = 0.5, fill = "blue") + labs(title = "Histogram of differences between estimated and true cluster mean") +
  geom_vline(xintercept = mean(data_binx_conty$diff), linetype = "dashed", color = "red")
...
p2.33t5 <- ggplot(data_binx_contyt5, aes(x = X.cluster.means, y = p.X.mean.j)) + geom_point() + labs(title = "T = 5") + xlim(0,1) + ylim(0,1)
p2.33t20 <- ggplot(data_binx_contyt20, aes(x = X.cluster.means, y = p.X.mean.j)) + geom_point() + labs(title = "T = 20") + xlim(0,1) + ylim(0,1)
...
# create overlapping density plots for X.cluster.means and p.X.mean.j
p3.41 <- ggplot(data_contx_biny, aes(x = X.cluster.means, fill = "X.cluster.means")) + geom_density(alpha = 0.5) +
  geom_density(aes(x = X.mean.j, fill = "p.X.mean.j"), alpha = 0.5) + labs(title = "Density plot of X.cluster.means and X.mean.j", x = "value")

# compute difference between estimated and true cluster mean for each cluster
data_contx_biny$diff <- data_contx_biny$X.cluster.means - data_contx_biny$X.mean.j

# plot histogram of differences
p3.42 <- ggplot(data_contx_biny, aes(x = diff)) + geom_histogram(aes(y = ..density..), bins = 30, fill = "lightblue", color = "black") +
  geom_density(alpha = 0.5, fill = "blue") + labs(title = "Histogram of differences between estimated and true cluster mean") +
  geom_vline(xintercept = mean(data_contx_biny$diff), linetype = "dashed", color = "red")
...
# create overlapping density plots for X.cluster.means and p.X.mean.j
p4.41 <- ggplot(data_binary, aes(x = X.cluster.means, fill = "X.cluster.means")) + geom_histogram(alpha = 0.8, binwidth = 0.02) +
...
# compute difference between estimated and true cluster mean for each cluster
data_binary$diff <- data_binary$X.cluster.means - data_binary$p.X.mean.j

# plot histogram of differences
p4.42 <- ggplot(data_binary, aes(x = diff)) + geom_histogram(aes(y = ..density..), bins = 30, fill = "lightblue", color = "black") +
  geom_density(alpha = 0.5, fill = "blue") + labs(title = "Histogram of differences between estimated and true cluster mean") +
  geom_vline(xintercept = mean(data_binary$diff), linetype = "dashed", color = "red")

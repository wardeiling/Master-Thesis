...
```
Strange behaviour when g.01 is negative or exceeds 0.8 (with T = 20). The intercept is borrowing from the slope. Happens more with a smaller number of total timepoints T.
...
WHY IS THE INTERCEPT BORROWING FROM THE g.01 SLOPE? 

...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, enhanced, sharp corners, interior hidden, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
relationships between variables. To address such data, the psychological
...
interdisciplinary research has introduced and compared these methods
...
methods, such critiques of the MLM not reach the applied researcher. And
when it does, the technical nature and jargon of the literature in other
fields may prevent these researchers from figuring out how and when
...
\leavevmode\vadjust pre{\hypertarget{ref-bou2018}{}}%

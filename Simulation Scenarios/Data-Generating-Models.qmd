...
**SCM with random intercept and a time-varying $X$ *without* between-person differences in $\bar{X}_i$ (a mean of 0 for everyone)**
...
**Ten opzichte van scenario 3, wordt er in dit scenario een time-invariant moderator $Z$ toegevoegd aan het model in het effect van $X$ op $Y$**
...
**Ten opzichte van scenario 3, wordt er in dit scenario een time-varying exogenous covariate $Z$ toegevoegd aan het model**



### Scenario 6

**Ten opzichte van scenario 3, wordt er in dit scenario een time-varying endogenous covariate $Z$ toegevoegd aan het model**

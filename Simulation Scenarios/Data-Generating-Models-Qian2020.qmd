...
<!-- We can also create a path diagram -->
...
<!--     Z1 [label = 'Z1', shape = box; group = left] -->
<!--     Y2 [label = 'Y2', shape = box; group = left] -->
<!--     Z2 [label = 'Z2', shape = box; group = right] -->
<!--     Y3 [label = 'Y3', shape = box; group = right] -->
<!--     u0 [label = 'u0', shape = circle; group = right] -->

<!--     # Set up rank to align nodes vertically -->
<!--     {rank=same; Z1; Z2} -->
<!--   {rank=same; Y2; Y3} -->
<!--   {rank=same; u0} -->
...
<!-- DiagrammeR::grViz(" -->
<!--   digraph flowchart { -->
<!--       # graph [layout = dot, rankdir = LR]  # Left to right layout -->
<!--       node [fontname = Arial, fontsize = 11] -->

<!--       # Define nodes -->
<!--       Z1 [label = 'Z1', shape = box; group = left] -->
<!--       u0 [label = 'u0', shape = circle; group = right] -->
<!--       Y2 [label = 'Y2', shape = box; group = right] -->
<!--       Z2 [label = 'Z2', shape = box; group = left] -->
<!--       Y3 [label = 'Y3', shape = box; group = right] -->
...
<!--       # Subgraphs to control rank -->
<!--       subgraph { -->
<!--           rank = same; Z1; Z2; u0;  # Rank for Z1 and u0 -->
<!--       } -->

<!--       subgraph { -->
<!--           rank = same; Y2; Y3;  # Rank for Y2, Z2, and Y3 -->
<!--       } -->
<!--   } -->
<!-- ") -->
...
<!--       # Define nodes -->
<!--       Z1 [label = 'Z1', shape = box; group = left] -->
<!--       u0 [label = 'u0', shape = circle; group = top]  # Positioning u0 at the top -->
<!--       Y2 [label = 'Y2', shape = box; group = right] -->
<!--       Z2 [label = 'Z2', shape = box; group = left] -->
<!--       Y3 [label = 'Y3', shape = box; group = right] -->
...
<!--       # Subgraphs to control rank -->
<!--       subgraph { -->
<!--           rank = same; Z1; Z2;  # Rank for Z1 and Z2 at the same level -->
<!--       } -->

<!--       subgraph { -->
<!--           rank = same; Y2; Y3;  # Rank for Y2 and Y3 at the same level -->
<!--       } -->

<!--       # Position u0 above Y2 and Y3 -->
<!--       subgraph { -->
<!--           rank = min; u0;  # This makes u0 the top node -->
<!--       } -->
<!--   } -->
<!-- ") -->
<!-- ``` -->
...
knitr::kable(section2.2_summary_stats, digits = 2, caption = "Mean estimates of fixed effects across simulations")
```
...
In what situations may psychological researchers be primarily interested in marginal effects over finding the 
...
We can estimate the marginal model and its parameter $\beta_1$ using GEE models.
...
# Simulation parameters
set.seed(123)
n_subjects <- 5000 # Number of subjects
max_time <- 10    # Maximum number of observations per subject
...
saveRDS(results_complete, file = "Diggle2002_results_Xlag.rds")
```
...
# Print the results
knitr::kable(results_complete, digits = 3, caption = "Average Estimates of Beta1 for Different Correlation Structures")
```

If we instead add the lagged variable `X_lag1` in the model, we do not obtain the marginal estimate of the fixed slope. Instead, we obtain the conditional estimate of the fixed slope, which is the effect of `X` on `Y` after accounting for the effect of `X_lag1`. The results are shown below.



```{r}
#| label: fig-Diggle2002
#| fig-cap: Average Estimates of Beta1 for Different Correlation Structures
#| echo: false
#| cache: false

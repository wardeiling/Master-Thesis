---
title: "Data Generating Models and Estimation Methods"
...
```{r}
#| label: Coefs_Scenario3_Centering
#| cache: true

lme4::fixef(lmer(Y ~ 1 + X_cwc_population + mu_bar + (1 | id), data = scenario3.data, REML = TRUE))
lme4::fixef(lmer(Y ~ 1 + X_cwc_population + mu_bar + (1 | id), data = scenario3.data, REML = FALSE))
```

So no, centering with the population mean seems to make the problem even worse.

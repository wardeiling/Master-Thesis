...
\subcaption{\label{fig-DAGs-1}Generative Model 1, 1A and 1B}
...
\subcaption{\label{fig-DAGs-2}Generative Model 2, 2A and 2B}
...
(\citeproc{ref-rcoreteam2024}{\textbf{rcoreteam2024?}}). To fit the GEE,
the R-package \texttt{geepack} (\citeproc{ref-halekoh2006}{Halekoh et
al., 2006}) will evaluate several different working correlation
structures, including independent, exchangeable, AR(1) and unstructured.
To fit the basic MLM, the R-package \texttt{lme4}
(\citeproc{ref-bates2015}{Bates et al., 2015}) will be employed, where

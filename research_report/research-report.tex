...
(\citeproc{ref-pepe1994}{1994}), it has also been well-established that
...
a recent paper by Qian et al. (\citeproc{ref-qian2020}{2020}) examined
...
statement by Qian et al. (\citeproc{ref-qian2020}{2020}) that ``applying
...
(\citeproc{ref-qian2020}{2020}) does not explicitly mention this
...
interaction effects\footnote{Note that the term ``effect modification'',
  ...
  (\citeproc{ref-vanderweele2009}{VanderWeele, 2009}).}, which are
...
(\citeproc{ref-attia2022}{Attia et al., 2022};
\citeproc{ref-weinberg2007}{Weinberg, 2007}). Future research could
...
(\citeproc{ref-pepe1994}{1994}). In the context of clustered
...
approaches (see Hamaker \& Muthén (\citeproc{ref-hamaker2020}{2020}) for
...
(\citeproc{ref-bell2015}{2015}), may further clarify how it impacts
treatment effect bias in GM G.

Finally, Qian et al. (\citeproc{ref-qian2020}{2020}) only considered
...
(\citeproc{ref-rovine2000}{Rovine \& Molenaar, 2000}) could provide

...
: Generative Models: Differences {#tbl-gm-differences}

The details of the generative models are described below. We follow the notation of @qian2020 to allow for direct comparison, but rewrite the equations into within- and between-person models [see @raudenbush2002].
...
Path Diagrams for Generative Models 1, 3, 3A, 3B (t = 1, 2, 3)
:::
...
DAGs for Generative Models 1, 3, 3A, 3B (t = 1, 2, 3)
:::
...
kableExtra::kbl(results, booktabs = T,  digits = c(0, 0, 0, 3, 3, 3), col.names = c("GM", "T", "N", "Bias", "SD", "SR")) %>%
  add_header_above(c(" " = 3, "MLM" = 3)) %>%

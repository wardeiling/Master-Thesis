...
This document allows for the exploration of the four data generating mechanisms underlying the simulation study of the manuscript "From Multilevel Modeling to GEE: Revisiting the Within- and Between-Person Debate with Binary Predictors and Outcomes". In this manuscript, the parameters have the following meaning
...
## DGM 2: Binary X and Continuous Y
...
## DGM 3: Continuous X and Binary Y
